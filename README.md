...
Install from the link https://sourceforge.net/projects/gnuplot/.
...
```
[dataset] [dataset_size] [poi_num] [epsilon] [point_cloud_to_terrain_time (ms)] [construction_time (ms)] [query_time (ms)] [min_query_time (ms)] [max_query_time (ms)] [point_cloud_to_terrain_memroy_usage (MB)] [memory_usage (MB)] [output_size (MB)] [distance_error_point_cloud] [distance_error_terrain] [knn_query_time] [knn_error_point_cloud] [knn_error_terrain] [range_query_time] [range_error_point_cloud] [range_error_terrain]
```