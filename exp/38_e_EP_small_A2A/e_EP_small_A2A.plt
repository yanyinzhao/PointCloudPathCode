...
"14_RC_Oracle_Naive_A2A.txt" using 4:(($5+$6)/1000) notitle with linespoints linetype 1 pointtype 6 linecolor rgbcolor "#000000", \
...
plot "13_SE_Oracle_Adapt_A2A.txt" using 4:($8+$9) notitle with linespoints linetype 1 pointtype 1 linecolor rgbcolor "#000000", \
"2_EAR_Oracle_Adapt.txt" using 4:($8+$9) notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
"14_RC_Oracle_Naive_A2A.txt" using 4:($8+$9) notitle with linespoints linetype 1 pointtype 6 linecolor rgbcolor "#000000", \
...
plot "13_SE_Oracle_Adapt_A2A.txt" using 4:10 notitle with linespoints linetype 1 pointtype 1 linecolor rgbcolor "#000000", \
"2_EAR_Oracle_Adapt.txt" using 4:10 notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
"14_RC_Oracle_Naive_A2A.txt" using 4:10 notitle with linespoints linetype 1 pointtype 6 linecolor rgbcolor "#000000", \
"15_RC_Oracle_A2A.txt" using 4:10 notitle with linespoints linetype 1 pointtype 4 linecolor rgbcolor "#FF0000"
...
plot "13_SE_Oracle_Adapt_A2A.txt" using 4:7 notitle with linespoints linetype 1 pointtype 1 linecolor rgbcolor "#000000", \
"2_EAR_Oracle_Adapt.txt" using 4:7 notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
"14_RC_Oracle_Naive_A2A.txt" using 4:7 notitle with linespoints linetype 1 pointtype 6 linecolor rgbcolor "#000000", \
...
"15_RC_Oracle_A2A.txt" using 4:7 notitle with linespoints linetype 1 pointtype 4 linecolor rgbcolor "#FF0000"
