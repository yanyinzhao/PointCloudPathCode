...
plot NaN title 'SE-Oracle-FastFly-Adapt-A2A' with linespoints linetype 1 pointtype 1 linecolor rgbcolor "#000000", \
...
plot "16_SE_Oracle_FastFly_Adapt_A2A.txt" using 4:10 notitle with linespoints linetype 1 pointtype 1 linecolor rgbcolor "#000000", \
...
plot "16_SE_Oracle_FastFly_Adapt_A2A.txt" using 4:7 notitle with yerrorlines linetype 1 pointtype 1 linecolor rgbcolor "#000000", \
...
plot "16_SE_Oracle_FastFly_Adapt_A2A.txt" using 4:($3*$3*$7) notitle with linespoints linetype 1 pointtype 1 linecolor rgbcolor "#000000", \
...
plot "16_SE_Oracle_FastFly_Adapt_A2A.txt" using 4:12 notitle with linespoints linetype 1 pointtype 1 linecolor rgbcolor "#000000", \
