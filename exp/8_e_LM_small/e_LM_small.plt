...
"3_RC_Oracle_Naive.txt" using 4:(($5+$6)/1000) notitle with linespoints linetype 1 pointtype 6 linecolor rgbcolor "#000000", \
...
"3_RC_Oracle_Naive.txt" using 4:($8+$9) notitle with linespoints linetype 1 pointtype 6 linecolor rgbcolor "#000000", \
