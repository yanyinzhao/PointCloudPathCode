...
"12_RC_Oracle_NaiveProx.txt" using 4:10 notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
...
plot "12_RC_Oracle_NaiveProx.txt" using 4:7 notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
...
plot "12_RC_Oracle_NaiveProx.txt" using 4:12 notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
