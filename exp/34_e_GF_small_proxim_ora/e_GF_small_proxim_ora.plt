set out "e_GF_small_proxim_ora.eps"
...
NaN title 'RC-Oracle-NaiveProx' with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
...
"12_RC_Oracle_NaiveProx.txt" using 4:11 notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
...
"12_RC_Oracle_NaiveProx.txt" using 4:12 notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
...
plot "12_RC_Oracle_NaiveProx.txt" using 4:7:9:8 notitle with yerrorlines linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
...
"12_RC_Oracle_NaiveProx.txt" using 4:(2*$3*$3*$7) notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
...
plot "12_RC_Oracle_NaiveProx.txt" using 4:14 notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
