...
plot "5_CH_Adapt.txt" using (floor($2/100000)):($8+$9) notitle with linespoints linetype 1 pointtype 8 linecolor rgbcolor "#808080", \
"6_Kaul_Adapt.txt" using (floor($2/100000)):($8+$9) notitle with linespoints linetype 1 pointtype 10 linecolor rgbcolor "#808080", \
"7_Dijk_Adapt.txt" using (floor($2/100000)):($8+$9) notitle with linespoints linetype 1 pointtype 12 linecolor rgbcolor "#808080", \
"8_FastFly.txt" using (floor($2/100000)):($8+$9) notitle with linespoints linetype 1 pointtype 14 linecolor rgbcolor "#0000FF", \
"4_RC_Oracle.txt" using (floor($2/100000)):($8+$9) notitle with linespoints linetype 1 pointtype 4 linecolor rgbcolor "#FF0000"
...
plot "4_RC_Oracle.txt" using (floor($2/100000)):10 notitle with linespoints linetype 1 pointtype 4 linecolor rgbcolor "#FF0000"
...
plot "5_CH_Adapt.txt" using (floor($2/100000)):($5+$7) notitle with linespoints linetype 1 pointtype 8 linecolor rgbcolor "#808080", \
"6_Kaul_Adapt.txt" using (floor($2/100000)):($5+$7) notitle with linespoints linetype 1 pointtype 10 linecolor rgbcolor "#808080", \
"7_Dijk_Adapt.txt" using (floor($2/100000)):($5+$7) notitle with linespoints linetype 1 pointtype 12 linecolor rgbcolor "#808080", \
"8_FastFly.txt" using (floor($2/100000)):($5+$7) notitle with linespoints linetype 1 pointtype 14 linecolor rgbcolor "#0000FF", \
"4_RC_Oracle.txt" using (floor($2/100000)):7 notitle with linespoints linetype 1 pointtype 4 linecolor rgbcolor "#FF0000"
...
plot "5_CH_Adapt.txt" using (floor($2/100000)):12 notitle with linespoints linetype 1 pointtype 8 linecolor rgbcolor "#808080", \
"6_Kaul_Adapt.txt" using (floor($2/100000)):12 notitle with linespoints linetype 1 pointtype 10 linecolor rgbcolor "#808080", \
"7_Dijk_Adapt.txt" using (floor($2/100000)):12 notitle with linespoints linetype 1 pointtype 12 linecolor rgbcolor "#808080", \
"8_FastFly.txt" using (floor($2/100000)):12 notitle with linespoints linetype 1 pointtype 14 linecolor rgbcolor "#0000FF", \
"4_RC_Oracle.txt" using (floor($2/100000)):12 notitle with linespoints linetype 1 pointtype 4 linecolor rgbcolor "#FF0000"
