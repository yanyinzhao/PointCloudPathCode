...
plot "1_SE_Oracle_Adapt.txt" using 3:($10+$11) notitle with linespoints linetype 1 pointtype 1 linecolor rgbcolor "#000000", \
"2_EAR_Oracle_Adapt.txt" using 3:($10+$11) notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
"3_RC_Oracle_Naive.txt" using 3:11 notitle with linespoints linetype 1 pointtype 6 linecolor rgbcolor "#000000", \
"5_CH_Adapt.txt" using 3:($10+$11) notitle with linespoints linetype 1 pointtype 8 linecolor rgbcolor "#808080", \
...
plot "1_SE_Oracle_Adapt.txt" using 3:7:9:8 notitle with yerrorlines linetype 1 pointtype 1 linecolor rgbcolor "#000000", \
"2_EAR_Oracle_Adapt.txt" using 3:7:9:8 notitle with yerrorlines linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
"3_RC_Oracle_Naive.txt" using 3:7:9:8 notitle with yerrorlines linetype 1 pointtype 6 linecolor rgbcolor "#000000", \
"5_CH_Adapt.txt" using 3:($5+$7):($5+$9):($5+$8) notitle with yerrorlines linetype 1 pointtype 8 linecolor rgbcolor "#808080", \
...
plot "1_SE_Oracle_Adapt.txt" using 3:14 notitle with linespoints linetype 1 pointtype 1 linecolor rgbcolor "#000000", \
"2_EAR_Oracle_Adapt.txt" using 3:14 notitle with linespoints linetype 1 pointtype 2 linecolor rgbcolor "#000000", \
"3_RC_Oracle_Naive.txt" using 3:14 notitle with linespoints linetype 1 pointtype 6 linecolor rgbcolor "#000000", \
"5_CH_Adapt.txt" using 3:14 notitle with linespoints linetype 1 pointtype 8 linecolor rgbcolor "#808080", \
