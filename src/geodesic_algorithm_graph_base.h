...
namespace geodesic
{
	...
	template <class Node>
	inline bool GeodesicAlgorithmGraphBase<Node>::check_stop_conditions_distance()
	{
	...
	template <class Node>
	inline bool GeodesicAlgorithmGraphBase<Node>::check_stop_conditions_cover_points(unsigned &index)
	{
		double queue_min_distance = (*m_queue.begin())->distance_from_source();
